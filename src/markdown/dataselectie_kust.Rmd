...
Een fossiel opgezwollen brakwaterhorentje en 4 fossiele wadslakjes.
...
70 verdere waarnemingen bevatten in notities het woord Holoceen, fossiel of 'middeleeuw'.
...
waarnemingen_kust_buffer <- land_zoetwater_kust_selectie %>%
  st_buffer(25)
```
