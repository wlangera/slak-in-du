...
1.  Afbakening van het Slak-in-Du gebied aan de kust. Het studiegebied kan dan gebruikt worden om de data te selecteren en UTM-hokken te selectieren die kunnen gebruikt worden om verspreidingskaarten te maken. Hoofdstuk \@ref(#inleiding).
